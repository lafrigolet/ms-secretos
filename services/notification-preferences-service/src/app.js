...
await app.register(swaggerPlugin, {
  openapi: {
    info: {
      title: 'Secretos del Agua — Notification Preferences Service',
      description: 'Preferencias, alertas y comunicaciones (HU-48 a HU-52)',
      version: '1.0.0'
    },
    tags: [
...
app.get('/health', async () => ({
  status: 'ok',
  service: 'sda-notification-preferences-service',
...
try {
  ...
  app.log.info(`Notification Preferences Service en puerto ${PORT}`)
